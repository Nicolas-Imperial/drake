...
#define PELIB_MAPPING_PROC_ID_CHAR_LENGTH 2
#define PELIB_MAPPING_NODE_CHAR_LENGTH 2
#define PELIB_MAPPING_SEPARATOR ':'
...
int pelib_processor_insert_task(processor_t *proc, task_t *task);
int pelib_processor_remove_task(processor_t *proc, task_id task);
size_t pelib_processor_find_task(processor_t *proc, task_id task);
