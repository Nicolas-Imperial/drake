...
void snekkja_schedule_init()
{
	...
	_snekkja_producers_id[2][0] = 4;
	_snekkja_producers_id[2][1] = 5;
	_snekkja_producers_id[3] = NULL;
	_snekkja_producers_id[4] = malloc(sizeof(size_t) * 2);
	_snekkja_producers_id[4][0] = 8;
	_snekkja_producers_id[4][1] = 9;
	_snekkja_producers_id[5] = malloc(sizeof(size_t) * 2);
	_snekkja_producers_id[5][0] = 10;
	_snekkja_producers_id[5][1] = 11;
	_snekkja_producers_id[6] = NULL;
	_snekkja_producers_id[7] = NULL;
	_snekkja_producers_id[8] = malloc(sizeof(size_t) * 2);
	_snekkja_producers_id[8][0] = 16;
	_snekkja_producers_id[8][1] = 17;
	_snekkja_producers_id[9] = malloc(sizeof(size_t) * 2);
	_snekkja_producers_id[9][0] = 18;
	_snekkja_producers_id[9][1] = 19;
	_snekkja_producers_id[10] = malloc(sizeof(size_t) * 2);
	_snekkja_producers_id[10][0] = 20;
	_snekkja_producers_id[10][1] = 21;
	_snekkja_producers_id[11] = malloc(sizeof(size_t) * 2);
	_snekkja_producers_id[11][0] = 22;
	_snekkja_producers_id[11][1] = 23;
	...
	_snekkja_producers_id[16][0] = 32;
	_snekkja_producers_id[16][1] = 33;
	_snekkja_producers_id[17] = malloc(sizeof(size_t) * 2);
	_snekkja_producers_id[17][0] = 34;
	_snekkja_producers_id[17][1] = 35;
	_snekkja_producers_id[18] = malloc(sizeof(size_t) * 2);
	_snekkja_producers_id[18][0] = 36;
	_snekkja_producers_id[18][1] = 37;
	_snekkja_producers_id[19] = malloc(sizeof(size_t) * 2);
	_snekkja_producers_id[19][0] = 38;
	_snekkja_producers_id[19][1] = 39;
	_snekkja_producers_id[20] = malloc(sizeof(size_t) * 2);
	_snekkja_producers_id[20][0] = 40;
	_snekkja_producers_id[20][1] = 41;
	_snekkja_producers_id[21] = malloc(sizeof(size_t) * 2);
	_snekkja_producers_id[21][0] = 42;
	_snekkja_producers_id[21][1] = 43;
	_snekkja_producers_id[22] = malloc(sizeof(size_t) * 2);
	_snekkja_producers_id[22][0] = 44;
	_snekkja_producers_id[22][1] = 45;
	_snekkja_producers_id[23] = malloc(sizeof(size_t) * 2);
	_snekkja_producers_id[23][0] = 46;
	_snekkja_producers_id[23][1] = 47;
